        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="{!! \URL::previous()!!}"> Cpr </a> | Recibo</div>
                                            ...
                                            <div class="jFiler-item-inner">
                                                <div class="jFiler-item-thumb">
                                                    ...
                                                    <div class="jFiler-item-info">
                                                        <span class="jFiler-item-title"><b title="{!! $receipt->file_name !!}">{!! $receipt->file_name !!} </b></span>
                                                    </div>
                                                    <div class="jFiler-item-thumb-image">
                                                        <img src="{!! asset($receipt->src.'/'.$receipt->file_name) !!}" draggable="false">
                                                    </div>
                                                </div>
                                                <div class="jFiler-item-assets jFiler-row">
                                                    <ul class="list-inline pull-left">
                                                        <li>
                                                            <a href="{!! route('investment.cpr.receipt.download', $receipt) !!}" class="icon-jfi-file-image jfi-file-ext-png"></a>
                                                        </li>
                                                    </ul>
                                                    <ul class="list-inline pull-right">
                                                        <li>
                                                            <a href="{!! route('investment.cpr.receipt.delete', $receipt) !!}" data-method="delete" class="icon-jfi-trash jFiler-item-trash-action"></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
