...
<div class="form-group{{ $errors->has('billet.agency') ? ' has-error' : '' }}">
    ...
    <div class="col-md-2 {{ $errors->has('billet.agency_dv') ? ' has-error' : '' }}">
...
<div class="form-group{{ $errors->has('billet.account') ? ' has-error' : '' }}"
    ...
    <div class="col-md-2 {{ $errors->has('billet.account_dv') ? ' has-error' : '' }}">
...
@endif
    ...
    {!! Form::label('template_id', 'Modelo *', ['class' => 'col-md-4 control-label']) !!}
